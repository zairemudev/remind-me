...
const Header = (props: Props) => {
  ...
  return (
    <header className="bg-white dark:bg-slate-800 flex flex-none h-16 items-center gap-6 px-4 sm:px-6 justify-between border-b border-gray-100 dark:border-slate-700">
      {/* logo */}
      <div className="flex font-medium text-2xl font-pacifico ml-2">
        <BellRing
          size={30}
          className="text-slate-700 dark:text-slate-500 rotate-15"
        />
